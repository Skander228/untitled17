        ...
        switch (commandName) {
            ...
            case "Организация": {
                ...
                response.replyMarkup(new ReplyKeyboardMarkup(
                        ...
                        new String[] {"Боксер; Борец; Велогонщик; Лыжник; Спортсмен; Теннисист; Футболист; Хоккеист; Шахматист"},
                        new String[] {"Инновации"}
                ).resizeKeyboard(true));
            ...
            case "Боксер; Борец; Велогонщик; Лыжник; Спортсмен; Теннисист; Футболист; Хоккеист; Шахматист": {
                lite(chatId,"Требования: НКЗ: 1)участие в соревнованиях; 2)проведение уроков; 3)спортивные мероприятия; 4)соблюдение правил. МСОК 4: 1)мероприятия на воздухе; 2)мероприятия в помещении; 3)помощь в проведении мероприятий; 4)работа спортсменов.", "Организация");
                break;
            }
            ...
            case "Организация мероприятий": {
                ...
                response.replyMarkup(new ReplyKeyboardMarkup(
                        new String[] {"Заведующий отделом рекламы; Руководитель отдела по связям с общественностью"},
                        new String[] {"Заведующий научно-исследовательской лабораторией;  Руководитель научно-исследовательского подразделения"},
                        new String[] {"Главный агроном; Главный мелиоратор; Главный охотовед; Заведующий отделом (в рыбном хозяйстве)"},
                        new String[] {"Главный технолог (обрабатывающая промышленность); Главный сварщик; Главный электроник"},
                        new String[] {"Главный металлург; Заведующий горными работами; Мастер буровой скважины; Начальник карьера"},
                        new String[] {"Главный архитектор; Мастер ремонтно-строительной группы; Начальник участка (в строительстве)"},
                        new String[] {"Мастер погрузочно-разгрузочных работ; Начальник службы (материально-технического снабжения)"},
                        new String[] {"Директор гостиницы (гостиничного учреждения); Директор отеля; Руководитель студенческого общежития"},
                        new String[] {"Директор (управляющий) вагона-ресторана; Директор кафе; Заведующий залом (ресторана, кафе и др.)"},
                        new String[] {"Директор магазина; Заведующий домом быта (моды); Заведующий отделом (в торговле)"},
                        new String[] {"Главный тренер; Директор физкультурно-спортивной организации; Директор фитнес-центра; Заведующий спортивной базой"},
                        new String[] {"Главный дирижер; Заведующий (руководитель) частью (литературно-драматической, режиссерской, художественно-постановочной"},
                        new String[] {"Директор выставочного центра; Заведующий парикмахерской; Руководитель туристического агентства"},
                        new String[] {"Педагог-организатор, начальная школа"},
                        new String[] {"Организация"}
                ).resizeKeyboard(true));
            ...
            case "Заведующий отделом рекламы; Руководитель отдела по связям с общественностью": {
                lite(chatId,"Требования: 1) проведение маркетинговых исследований; 1) осуществление деятельности по связям с общественностью; 2) предоставление всех видов услуг в области рекламы; 2) переговоры по вопросам рекламных контрактов; 3) изучение общественного мнения по разным вопросам; 3) планирование и управление информационными программами; 4) выдача рекомендаций в сфере связей с общественностью; 4) управление деятельностью персонала, занятого рекламой и связями с общественностью", "Организация мероприятий");
                break;
            }

            case "Заведующий научно-исследовательской лабораторией;  Руководитель научно-исследовательского подразделения": {
                lite(chatId,"Требования: 1) фундаментальные и прикладные исследования; 1) планирование, управление и координация научной-исследовательской деятельности; 2) экспериментальные разработки в области естественных наук; 2) планирование исследований и программ с учётом бюджета; 3) экспериментальные разработки в области технических наук; 3) руководство и управление деятельностью персонала; 4) деятельность административных отделов; 4) управление бюджетами и контроль расходов;", "Организация мероприятий");
                break;
            }

            case "Главный агроном; Главный мелиоратор; Главный охотовед; Заведующий отделом (в рыбном хозяйстве)": {
                lite(chatId,"Требования: 1) разные виды коммерческих услуг; 1) планирование производства; 2) консультирование в области сельского хозяйства; 2) заключение контрактов с фермерами по производству продукции; 3) деятельность охотничьих и рыболовных заповедников; 3) анализ почвы; 4) деятельность после сбора урожая, направленная на сбыт; 4) планирование работ, обеспечение оборудованием;", "Организация мероприятий");
                break;
            }

            case "Главный технолог (обрабатывающая промышленность); Главный сварщик; Главный электроник": {
                lite(chatId,"Требования: 1) оказание коммерческих услуг; 1) определение производственного плана; 2) сварочные работы; 2) управление работой производственного оборудования; 3) наблюдение и управление подразделениями компании; 3) изучение и внедрение требований законодательства; 4) сертификация продукции; 4) консультирование и информирование по производственным вопросам;", "Организация мероприятий");
                break;
            }

            case "Главный металлург; Заведующий горными работами; Мастер буровой скважины; Начальник карьера": {
                lite(chatId,"Требования: 1) обеспечение функционирования шахт или карьеров; 1) установление квот на добычу, планирование участков добычи; 2) проведение всех видов бурения; 2) оценка продуктивности производственных площадок; 3) предоставление вспомогательных услуг для горнодобывающих предприятий; 3) планирование производственной деятельности; 4) наблюдение и управление другими подразделениями компании; 4) управление работой оборудования и технологическими процессами;", "Организация мероприятий");
                break;
            }

            case "Главный архитектор; Мастер ремонтно-строительной группы; Начальник участка (в строительстве)": {
                lite(chatId,"Требования: 1) предоставление архитектурных и инженерно-технических услуг; 1) понимание архитектурных чертежей и спецификаций; 2) управление проектами строительства; 2) переговоры с владельцами зданий, застройщиками и подрядчиками; 3) консультация в области архитектурных работ; 3) разработка и реализация программы работы на объектах; 4) подготовка территории строительной площадки; 4) обеспечение соблюдения строительного законодательства;", "Организация мероприятий");
                break;
            }

            case "Мастер погрузочно-разгрузочных работ; Начальник службы (материально-технического снабжения)": {
                lite(chatId,"Требования: 1) деятельность, связанная с погрузочно-разгрузочными работами; 1) определение и мониторинг реализации планов закупок хранения и распространения; 2) погрузка и разгрузка грузов и багажа пассажиров; 2) поддержание необходимых уровней запасов; 3) погрузка и разгрузка опасных грузов; 3) заключение договоров с поставщиками; 4) загрузка и разгрузка грузовых железнодорожных вагонов; 4) контроль систем хранения и учёта товаров;", "Организация мероприятий");
                break;
            }

            case "Директор гостиницы (гостиничного учреждения); Директор отеля; Руководитель студенческого общежития": {
                lite(chatId,"Требования: 1) деятельность гостиниц; 1) ведения хозяйственной деятельности, бронирования мест; 2) предоставление дополнительных услуг посетителям; 2) надзор за мерами безопасности; 3) предоставление мест для проживания; 3) управление деятельностью баров и ресторанов; 4) предоставление мест в общежитиях; 4) предоставление местной туристической информации;", "Организация мероприятий");
                break;
            }

            case "Директор (управляющий) вагона-ресторана; Директор кафе; Заведующий залом (ресторана, кафе и др.)": {
                lite(chatId,"Требования: 1) деятельность ресторанов, кафе; 1) планирование меню; 2) предоставление питания независимо от места; 2) организация специальных функций, связанных с общественным питанием; 3) подготовка и подача пищи с транспортных средств; 3) покупка ингредиентов; 4) доставка продуктов питания; 4) ведение переговоров;", "Организация мероприятий");
                break;
            }

            case "Директор магазина; Заведующий домом быта (моды); Заведующий отделом (в торговле)": {
                lite(chatId,"Требования: 1) деятельность универсальных магазинов; 1) определение ассортимента и уровня запасов; 2) розничная торговля ассортиментом; 2) разработка и реализация политики закупок; 3) оптовая торговля от собственного имени; 3) продвижение и реклама; 4) оптовая торговля, осуществляемая агентами; 4) ведение учёта запасов;", "Организация мероприятий");
                break;
            }

            case "Главный тренер; Директор физкультурно-спортивной организации; Директор фитнес-центра; Заведующий спортивной базой": {
                lite(chatId,"Требования: 1) организация спортивных мероприятий; 1) планирование и контроль деятельности спортивной организации; 2) деятельность объектов по проведению спортивных мероприятий; 2) организация спортивно-массовой работы среди населения; 3) деятельность клубов фитнеса и бодибилдинга; 3) разработка и управление бюджетами; 4) организация спортивных мероприятий на открытом воздухе и в помещении; 4) оснащение организации спортивным инвентарём;", "Организация мероприятий");
                break;
            }

            case "Главный дирижер; Заведующий (руководитель) частью (литературно-драматической, режиссерской, художественно-постановочной": {
                lite(chatId,"Требования: 1) деятельность организаторов мероприятий, не связанных со спортом или искусством; 1) планирование и организация развлечений и мероприятий; 2) деятельность в области искусства и развлечений; 2) содержание объектов в хорошем в состоянии; 3) показ кинофильмов и видеороликов; 3) учёт тенденций в художественном творчестве; 4) создание условий для отдыха; 4) консультирование по возможностям размещения рекламы;", "Организация мероприятий");
                break;
            }

            case "Директор выставочного центра; Заведующий парикмахерской; Руководитель туристического агентства": {
                lite(chatId,"Требования: 1) продажа путешествий, туров; 1) бронирование мест; 2) различные туристические услуги; 2) содействие проведению конференций; 3) наблюдение и управление подразделениями компании; 3) консультирование по запросам услуг, расходов на проживание; 4) организация, продвижение и управление событиями; 4) учёт запасов, ведение бюджета;", "Организация мероприятий");
                break;
            }

            case "Педагог-организатор, начальная школа": {
                lite(chatId,"Требования: 1) деятельность организаторов, не связанных с искусством или спортом; 1) планирование и проведение мероприятий с участием детей; 2) организация развлечений; 2) присмотр за детьми; 3) предоставление обучение в области искусств; 3) участие в собраниях персонала школы; 4) организация и постановка сценических выступлений; 4) подготовка планов в соответствии с требованиями;", "Организация мероприятий");
                break;
            }
            ...
            case "Организация деятельности": {
                ...
                response.replyMarkup(new ReplyKeyboardMarkup(
                        new String[] {"Координатор выставок; Организатор конференций; Организатор свадеб; Организатор семинаров"},
                        new String[] {"Генеральный директор; Директор завода; Директор театра; Исполнительный директор, дирекция"},
                        new String[] {"Директор по персоналу; Руководитель по производственным отношениям"},
                        new String[] {"Руководитель по стратегическому планированию; Руководитель управления по развитию компании"},
                        new String[] {"Руководитель по риск-менеджменту; Управляющий (в коммерческой деятельности)"},
                        new String[] {"Директор коммерческий; Руководитель службы маркетинга"},
                        new String[] {"Руководитель (управляющий) Call-центра; Руководитель (управляющий) службой сервиса для клиентов"},
                        new String[] {"Руководитель кредитного отдела; Управляющий страховым агентством"},
                        new String[] {"Проджект-менеджер, Менеджер проекта, Продукт-менеджер"},
                        new String[] {"Организация"}
                ).resizeKeyboard(true));
            ...
            case "Координатор выставок; Организатор конференций; Организатор свадеб; Организатор семинаров": {
                lite(chatId,"Требования: 1) деятельность организаторов, не связанных с искусством или спортом; 1) содействие проведению конференций; 2) разные виды коммерческих услуг; 2) ответ на запросы, касающиеся расходов; 3) наблюдение и управление подразделениями компании; 3) проведение встреч и обсуждение условий; 4) организация и управление событиями; 4) оборудование и оформление мероприятий;", "Организация деятельности");
                break;
            }

            case "Генеральный директор; Директор завода; Директор театра; Исполнительный директор, дирекция": {
                lite(chatId,"требования: 1) консультация по вопросам управление; 1) планирование и координация; 2) оперативное управление, стратегическое планирование, принятие решений; 2) анализ работы и результатов деятельности; 3) деятельность головных офисов; 3) определение целей и стратегий; 4) деятельность административных отделов; 4) обеспечение полного руководства;", "Организация деятельности");
                break;
            }

            case "Директор по персоналу; Руководитель по производственным отношениям": {
                lite(chatId,"Требования: 1) ведение списка вакансий, занятости и обращений; 1) планирование, руководство и координация деятельности персонала; 2) поиск персонала и отбор кандидатов; 2) организация процедуры приёма на работу; 3) функционирование кастинговых агентств; 3) организация переговоров; 4) функционирование бирж трудоустройства; 4) обеспечение соблюдение законодательства, касающегося прав работника;", "Организация деятельности");
                break;
            }

            case "Руководитель по стратегическому планированию; Руководитель управления по развитию компании": {
                lite(chatId,"Требования: 1) консультация или оказания оперативной помощи; 1) разработка и реализация стратегических планов; 2) наблюдение и управление подразделениями компании; 2) координация при реализации стратегических планов; 3) деятельность головных офисов; 3) измерение деятельности и отчётность о результатах; 4) деятельность административных отделов; 4) проведение консультаций с руководством;", "Организация деятельности");
                break;
            }

            case "Руководитель по риск-менеджменту; Управляющий (в коммерческой деятельности)": {
                lite(chatId,"Требования: 1) консультирование и оказание помощи организациям; 1) исследование и рекомендации для руководства по вопросам управление рисками; 2) осуществление оперативного и стратегического планирования; 2) управление ресурсами организации; 3) оказание оперативной помощи по проблемам управления; 3) представительство от имени предприятия на переговорах; 4) выдача рекомендаций компаниям; 4) разработка и управление бюджетами;", "Организация деятельности");
                break;
            }

            case "Директор коммерческий; Руководитель службы маркетинга": {
                lite(chatId,"Требования: 1) консультирование организации в сфере маркетинга; 1) организация маркетинговых программ; 2) оказание оперативной помощи организациям; 2) создание условий для стимулирования продаж; 3) проведение маркетинговых исследований; 3) руководство процедурами, связанными с маркетингом; 4) управление подразделениями компании; 4) руководство деятельностью персонала по продажам;", "Организация деятельности");
                break;
            }

            case "Руководитель (управляющий) Call-центра; Руководитель (управляющий) службой сервиса для клиентов": {
                lite(chatId,"Требования: 1) консультация и оказание оперативной помощи по проблемам управления; 1) подготовка необходимой документации; 2) наблюдение и управление подразделениями компании; 2) контроль качества и обработки телефонных звонков; 3) изучение общественного мнения по разным вопросам; 3) консультирование персонала по стандартам; 4) лоббирование в сфере связей с общественностью; 4) управление деятельностью персонала , занятого в Call-центре.", "Организация деятельности");
                break;
            }

            case "Руководитель кредитного отдела; Управляющий страховым агентством": {
                lite(chatId,"Требования: 1) страхование жизни; 1) планирование, руководство и координация деятельности персонала; 2) предоставление страховых услуг, кроме страхования жизни; 2) установление и поддержание отношений с клиентами", "Организация деятельности");
                break;
            }

            case "Проджект-менеджер, Менеджер проекта, Продукт-менеджер": {
                lite(chatId,"Требования: 1 Разработка MVP продукта 1 Планирование графика разработки; 2 Придумывание особенностей продукта 2 Планирование бюджета разработки; 3 Координация команды проекта 3 Общение с заказчиками; 4 Распоряжение ресурсами проекта 4 Ведение документации проекта", "Организация деятельности");
                break;
            }
            ...
            case "Занятия спортом": {
                ...
                response.replyMarkup(new ReplyKeyboardMarkup(
                        new String[] {"Борец; Велогонщик; Лыжник; Спортсмен; Теннисист; Футболист; Хоккеист; Шахматист"},
                        new String[] {"Директор физкультурно-спортивной организации; Директор фитнес-центра; Заведующий спортивной базой"},
                        new String[] {"Актер дубляжа; Ведущий программы новостей; Ведущий/ведущая ток-шоу; Диктор редакции радиовещания; Спортивный комментатор"},
                        new String[] {"Артист; Артист-воздушный гимнаст; Артист спортивно-акробатического жанра; Артист цирка"},
                        new String[] {"Спорт"}
                ).resizeKeyboard(true));
            ...
            case "Борец; Велогонщик; Лыжник; Спортсмен; Теннисист; Футболист; Хоккеист; Шахматист": {
                lite(chatId,"Требования: НКЗ: 1)участие в соревнованиях; 2)проведение уроков; 3)спортивные мероприятия; 4)соблюдение правил. МСОК 4: 1)мероприятия на воздухе; 2)мероприятия в помещении; 3)помощь в проведении мероприятий; 4)работа спортсменов.", "Занятия спортом");
                break;
            }

            case "Директор физкультурно-спортивной организации; Директор фитнес-центра; Заведующий спортивной базой": {
                lite(chatId,"Требования: НКЗ: 1)административный контроль; 2)планирование бюджета; 3)оснащение инвентарём; 4)подбор персонала. МСОК 4: 1)управление организацией; 2)организация деятельности; 3)принятие рещений; 4)оперативный контроль.", "Занятия спортом");
                break;
            }

            case "Актер дубляжа; Ведущий программы новостей; Ведущий/ведущая ток-шоу; Диктор редакции радиовещания; Спортивный комментатор": {
                lite(chatId,"Требования: НКЗ: 1)зачитывание новостей; 2)представление лиц; 3)проведение интервью; 4)изучение материалов. МСОК 4: 1)производство представлений; 2)групповая работа; 3)актерская работа; 4)работа залов.", "Занятия спортом");
                break;
            }

            case "Артист; Артист-воздушный гимнаст; Артист спортивно-акробатического жанра; Артист цирка": {
                lite(chatId,"Требования: НКЗ: 1)пересказ смешных историй; 2)развлечение зрителей; 3)представление номеров; 4)дрессировка животных. МСОК 4: 1)живые выступления; 2)театральные представления; 3)групповая работа; 4)работа залов.", "Занятия спортом");
                break;
            }
            ...
            case "Тренерская деятельность": {
                ...
                response.replyMarkup(new ReplyKeyboardMarkup(
                        new String[] {"Арбитр, спортивный; Рефери; Судья по спорту; Тренер; Инструктор-методист спортивной школы"},
                        new String[] {"Инструктор по аэробике; Инструктор по альпинизму и скалолазанию; Инструктор по дайвингу"},
                        new String[] {"Инструктор по вождению; Инструктор по картингу; Инструктор по росписи; Инструктор по танцам; Игропедагог"},
                        new String[] {"Преподаватель дополнительного образования; Преподаватель бальных танцев; Преподаватель музыкальной школы"},
                        new String[] {"Инструктор по лечебной физкультуре; Медицинская сестра по диетическому питанию"},
                        new String[] {"Массажист; Медицинская(ий) сестра/брат; Медицинская(ий) сестра/брат (специализированная(ый); Медицинская(ий) сестра/брат по уходу"},
                        new String[] {"Инженерно-педагогический работник колледжа в области гуманитарных наук; Инженерно-педагогический работник в области права"},
                        new String[] {"Преподаватель в области гуманитарных наук; Профессор в области права; Преподаватель в области искусства"},
                        new String[] {"Специалист по инженерной психологии; Психолог, промышленный; Психопедагог; Спортивный психолог"},
                        new String[] {"Аукционист; Литературный агент; Музыкальный агент; Спортивный агент; Театральный агент"},
                        new String[] {"Спорт"}
                ).resizeKeyboard(true));
            ...
            case "Арбитр, спортивный; Рефери; Судья по спорту; Тренер; Инструктор-методист спортивной школы": {
                lite(chatId,"Требования: НКЗ: 1)оценка возможностей; 2)разработка программ; 3)контроль соблюдения правил; 4)проведение мероприятий. МСОК 4: 1)услуги тренеров; 2)спортивное обучение; 3)обучение плаванию; 4)обучение на базах.", "Тренерская деятельность");
                break;
            }

            case "Инструктор по аэробике; Инструктор по альпинизму и скалолазанию; Инструктор по дайвингу": {
                lite(chatId,"Требования: НКЗ: 1)оценка способностей; 2)обучение движениям; 3)работа с оборудованием; 4)техника безопасности. МСОК 4: 1)услуги тренеров; 2)спортивное обучение; 3)обучение плаванию; 4)обучение на базах.", "Тренерская деятельность");
                break;
            }

            case "Инструктор по вождению; Инструктор по картингу; Инструктор по росписи; Инструктор по танцам; Игропедагог": {
                lite(chatId,"Требования: НКЗ: 1)составление планов; 2)проведение инструктажей; 3)обучение; 4)улучшение навыков МСОК 4: 1)услуги тренеров; 2)спортивное обучение; 3)обучение плаванию; 4)обучение на базах", "Тренерская деятельность");
                break;
            }

            case "Преподаватель дополнительного образования; Преподаватель бальных танцев; Преподаватель музыкальной школы": {
                lite(chatId,"Требования: НКЗ 1)работа кружков; 2)комплектование состава; 3)разработка графиков работы; 4)проведение занятий. МСОК 4 1)образование в сфере искусства; 2)организованное обучение; 3)обучение игре на фортепьяно; 4)обучение танцам.", "Тренерская деятельность");
                break;
            }

            case "Инструктор по лечебной физкультуре; Медицинская сестра по диетическому питанию": {
                lite(chatId,"Требования: НКЗ: 1)опрос и обследование пациентов; 2)наблюдение за пациентами; 3)работа с документами; 4)взаимодействие с другими специалистами. МСОК 4: 1)работа больниц; 2)здравоохранение; 3)неотложная помощь; 4)медицинский осмотр.", "Тренерская деятельность");
                break;
            }

            case "Массажист; Медицинская(ий) сестра/брат; Медицинская(ий) сестра/брат (специализированная(ый); Медицинская(ий) сестра/брат по уходу": {
                lite(chatId,"Требования: НКЗ: 1)проведение процедур; 2)уход за пациентами; 3)введение лекарств; 4)предоставление помощи. МСОК 4: 1)медицинский осмотр; 2)медицинские услуги; 3)охрана здоровья; 4)парамедицинская деятельность.", "Тренерская деятельность");
                break;
            }

            case "Инженерно-педагогический работник колледжа в области гуманитарных наук; Инженерно-педагогический работник в области права": {
                lite(chatId,"Требования: НКЗ: 1)разработка программ; 2)чтение лекций; 3)работа с инструментами 4)проверка проектов. МСОК 4: 1)профессиональное образование: 2)техническое образование; 3)обучение поваров; 4)обучение ремонту компьютеров.", "Тренерская деятельность");
                break;
            }

            case "Преподаватель в области гуманитарных наук; Профессор в области права; Преподаватель в области искусства": {
                lite(chatId,"Требования: НКЗ 1)разработка программ; 2)чтение лекций; 3)проверка контрольных работ. 4)участие в семинарах. МСОК 4 1)получение высшего образования; 2)получение квалификации; 3)проведение исследований; 4)присвоение ученых степеней.", "Тренерская деятельность");
                break;
            }

            case "Специалист по инженерной психологии; Психолог, промышленный; Психопедагог; Спортивный психолог": {
                lite(chatId,"Требования: НКЗ 1)диагностика нарушений; 2)подготовка отчетов; 3)разработка тестов; 4)проведение опросов. МСОК 4 1)вспомогательные услуги; 2)профориентация; 3)оценка систем тестирования; 4)тестирование.", "Тренерская деятельность");
                break;
            }

            case "Аукционист; Литературный агент; Музыкальный агент; Спортивный агент; Театральный агент": {
                lite(chatId,"Требования: НКЗ 1)получение информации об услугах; 2)заключение договоров; 3)продажи на аукционе; 4)организация туров. МСОК 4 1)розничная торговля книгами; 2)розничная торговля товарами; 3)торговля антиквариатом; 4)аукционные дома.", "Тренерская деятельность");
                break;
            }
